...
public abstract class BlockBase {
    ...
    public static class Info {
        ...
        Function<IBlockData, BlockBase.EnumRandomOffset> offsetType;
        ...
        public static BlockBase.Info copy(BlockBase blockbase) {
            ...
            blockbase_info.offsetType = blockbase.properties.offsetType;
        ...
        public BlockBase.Info offsetType(BlockBase.EnumRandomOffset blockbase_enumrandomoffset) {
            return this.offsetType((iblockdata) -> {
                return blockbase_enumrandomoffset;
            });
        }

        public BlockBase.Info offsetType(Function<IBlockData, BlockBase.EnumRandomOffset> function) {
    ...
    public abstract static class BlockData extends IBlockDataHolder<Block, IBlockData> {
        ...
        private final BlockBase.EnumRandomOffset offsetType;
        @Nullable
        ...
        protected BlockData(Block block, ImmutableMap<IBlockState<?>, Comparable<?>> immutablemap, MapCodec<IBlockData> mapcodec) {
            ...
            this.offsetType = (BlockBase.EnumRandomOffset) blockbase_info.offsetType.apply(this.asState());
        }
        ...
        public Vec3D getOffset(IBlockAccess iblockaccess, BlockPosition blockposition) {
            if (this.offsetType == BlockBase.EnumRandomOffset.NONE) {
                return Vec3D.ZERO;
            } else {
                ...
                double d1 = this.offsetType == BlockBase.EnumRandomOffset.XYZ ? ((double) ((float) (i >> 4 & 15L) / 15.0F) - 1.0D) * (double) block.getMaxVerticalOffset() : 0.0D;
        ...
        private static final class Cache {
            ...
            Cache(IBlockData iblockdata) {
                ...
                if (!this.collisionShape.isEmpty() && iblockdata.getOffsetType() != BlockBase.EnumRandomOffset.NONE) {
